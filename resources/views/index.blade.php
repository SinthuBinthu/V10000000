...
<main>
        ...
        <div class="swiper-slide">
            <div class="overflow-hidden position-relative h-100">
                ...
                <div class="slideshow-text container position-absolute start-50 top-50 translate-middle">
                    ...
                    <a href="{{ $slide->link }}" 
                       class="btn-link btn-link_lg default-underline fw-medium animate animate_fade animate_btt animate_delay-7">Jetzt Einkaufen</a>
                </div>
            </div>
        </div>
        @endforeach
    ...
    <div class="container mw-1620 bg-white border-radius-10">
      ...
      <section class="category-carousel container">
        <h2 class="section-title text-center mb-3 pb-xl-2 mb-xl-4">Vielleicht Magst du das</h2>
      ...
      <section class="hot-deals container">
        ...
        <div class="row">
          <div
            ...
            <h2>Summer Sale</h2>
            <h2 class="fw-bold">Bis zu 5% Rabatt</h2>

            <div class="position-relative d-flex align-items-center text-center pt-xxl-4 js-countdown mb-3"
              data-date="18-3-2024" data-time="06:50">
              <div class="day countdown-unit">
                <span class="countdown-num d-block"></span>
                <span class="countdown-word text-uppercase text-secondary">Tag</span>
              </div>

              <div class="hour countdown-unit">
                <span class="countdown-num d-block"></span>
                <span class="countdown-word text-uppercase text-secondary">Stunden</span>
              </div>

              <div class="min countdown-unit">
                <span class="countdown-num d-block"></span>
                <span class="countdown-word text-uppercase text-secondary">Minuten</span>
              </div>

              <div class="sec countdown-unit">
                <span class="countdown-num d-block"></span>
                <span class="countdown-word text-uppercase text-secondary">Sekunden</span>
              </div>
            </div>

            <a href="{{route('shop.index')}}" class="btn-link default-underline text-uppercase fw-medium mt-3">Alle Anzeigen</a>
          </div>
          ...
          <div class="col-md-6">
            <div class="category-banner__item border-radius-10 mb-5">
              ...
              <div class="category-banner__item-content">
                ...
                <a href="#" class="btn-link default-underline text-uppercase fw-medium">Jetzt Einkaufen</a>
              </div>
            </div>
          </div>
        </div>
      ...
      <section class="products-grid container">
        <h2 class="section-title text-center mb-3 pb-xl-3 mb-xl-4">Featured Produkte</h2>
        ...
        <div class="text-center mt-2">
          <a class="btn-link btn-link_lg default-underline text-uppercase fw-medium" href="#">Mehr Anzeigen</a>
        </div>
      </section>
    </div>
