        ...
        <div class="shopping-cart">
            ...
            <div class="cart-table__wrapper">
                ...
                <div class="cart-table-footer">
                    <input class="form-control" type="text" name="coupon_code" placeholder="Gutscheincode">
                            <input class="btn-link fw-medium position-absolute top-0 end-0 h-100 px-4" type="submit" value="GUTSCHEIN EINLÖSEN">                                                                           
                        <form class="position-relative bg-body" method="POST" action="{{route('cart.empty')}}">
                            @csrf
                            @method('DELETE')
                            <button class="btn btn-light" type="submit">Warenkorb leeren</button>
                        </form>
                    </form>
                </div>                
            </div>
                ...
                <div class="sticky-content">
                    ...
                    <div class="mobile_fixed-btn_wrapper">
                        <div class="button-wrapper container">
                            <a href="{{route('cart.checkout')}}" class="btn btn-primary btn-checkout">ZUR KASSE</a>
                        </div>
                    </div>
                </div>
            </div>
            @else
                <div class="row">
                    <div class="col-md-12 text-center pt-5 pb-5">
                        <p>Keine Artikel in deinem Warenkorb gefunden</p>
                        <a href="{{route('shop.index')}}" class="btn btn-info">Jetzt einkaufen</a>
                    </div>
                </div>
            @endif
        </div>
