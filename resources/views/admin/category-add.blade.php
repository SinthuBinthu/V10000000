    ...
    <div class="main-content-wrap">
        <div class="flex items-center flex-wrap justify-between gap20 mb-27">
            ...
            <ul class="breadcrumbs flex items-center flex-wrap justify-start gap10">
                ...
                <li>
                    <a href="{{route('admin.categories')}}"><div class="text-tiny">Kategorie</div></a>
                </li>
                <li>
                    <i class="icon-chevron-right"></i>
                </li>
                <li>
                    <div class="text-tiny">Neue Kategorie</div>
                </li>
            </ul>
        </div>
        <!-- new-category -->
        <div class="wg-box">
            <form class="form-new-product form-style-1" action="{{route('admin.category.store')}}" method="POST" enctype="multipart/form-data">
                @csrf
                <fieldset class="name">
                    <div class="body-title">Kategorie Name <span class="tf-color-1">*</span></div>
                ...
                <fieldset class="name">
                    <div class="body-title">Kategorie Slug <span class="tf-color-1">*</span></div>
                ...
                <fieldset>
                    <div class="body-title">Bild hochladen<span class="tf-color-1">*</span></div>
                    <div class="upload-image flex-grow">
                        ...
                        <div id="upload-file" class="item up-load">
                            <label class="uploadfile" for="myFile">
                                ...
                                <span class="body-text">Drag and Drop das Bild oder einfügen <span class="tf-color">Klicken zum browsen</span></span>
