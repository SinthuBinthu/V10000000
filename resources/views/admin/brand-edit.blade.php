    ...
    <div class="main-content-wrap">
            ...
            <ul class="breadcrumbs flex items-center flex-wrap justify-start gap10">
                ...
                <li>
                    <a href="{{ route('admin.brand.add') }}">
                        <div class="text-tiny">Marken</div>
                    </a>
                </li>
                <li>
                    <i class="icon-chevron-right"></i>
                ...
                <li>
                    <div class="text-tiny">Marke Bearbeiten</div>
                </li>
            </ul>
        </div>
        <!-- edit-brand -->
        <div class="wg-box">
            <form class="form-new-product form-style-1" action="{{ route('admin.brand.update') }}" method="POST" enctype="multipart/form-data">
                ...
                <fieldset class="name">
                    <div class="body-title">Marken Namen <span class="tf-color-1">*</span></div>
                    ...
                    <div class="upload-image flex-grow">
                        ...
                        <div id="upload-file" class="item up-load">
                            <label class="uploadfile" for="myFile">
                                ...
                                <span class="body-text">Bild einfügen <span class="tf-color">Drücken zum browsen</span></span>
