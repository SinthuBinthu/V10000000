    ...
    <div class="main-content-wrap">
        <div class="flex items-center flex-wrap justify-between gap20 mb-27">
            ...
            <ul class="breadcrumbs flex items-center flex-wrap justify-start gap10">
                ...
                <li>
                    <div class="text-tiny">Neuer Coupon</div>
                </li>
            </ul>
        </div>        
        <!-- new-category -->
        <div class="wg-box">
            <form class="form-new-product form-style-1" method="POST" action="{{route('admin.coupon.store')}}" >
                ...
                <fieldset class="category">
                    <div class="body-title">Coupon Typ</div>
                ...
                <fieldset class="name">
                    <div class="body-title">Wert <span class="tf-color-1">*</span></div>
                ...
                <fieldset class="name">
                    <div class="body-title">Einkaufswagen Wert <span class="tf-color-1">*</span></div>
                ...
                <fieldset class="name">
                    <div class="body-title">Gültigungs Datum <span class="tf-color-1">*</span></div>
