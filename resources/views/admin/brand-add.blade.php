    ...
    <div class="main-content-wrap">
        <div class="flex items-center flex-wrap justify-between gap20 mb-27">
            ...
            <ul class="breadcrumbs flex items-center flex-wrap justify-start gap10">
                ...
                <li>
                    <div class="text-tiny">Neue Marke</div>
                </li>
            </ul>
        </div>
        <!-- new-category -->
        <div class="wg-box">
            <form class="form-new-product form-style-1" action="{{route('admin.brand.store')}}" method="POST" enctype="multipart/form-data">
                ...
                <fieldset>
                    <div class="body-title">Bild Raufladen <span class="tf-color-1">*</span>
                    </div>
                    <div class="upload-image flex-grow">
                        ...
                        <div id="upload-file" class="item up-load">
                            <label class="uploadfile" for="myFile">
                                ...
                                <span class="body-text">Bild einfügen oder auswählen <span
                                        class="tf-color">Drücke zum Browsern</span></span>
