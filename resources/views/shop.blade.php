                ...
                <ul class="list list-inline mb-0">
                  ...
                  <li class="list-item">
                      <sapn class="menu-link py-1">
                          ...
                          @if(in_array($category->id, explode(',', $f_categories))) <input type="checkbox" name="brand[]" value="sw1" checked> @endif
                  ...
                  @foreach ($brands as $brand)
                      <li class="list-item">
                          <span class="menu-link py-1">
                              ...
                              @if(in_array($brand->id, explode(',', $f_brands))) <input type="checkbox" name="brand[]" value="sw1" checked> @endif
                              {{ $brand->name }}
                          </span>
  ...
  <div class="accordion-item mb-4">
    ...
    <div
      ...
      <div class="price-range__info d-flex align-items-center mt-2">
        <div class="me-auto">
          <span class="text-secondary">Min Preis:&nbsp;</span>
          <span class="price-range__min">${{ $min_price }}</span>
        </div>
        <div>
          <span class="text-secondary">Max Preis:&nbsp;</span>
      ...
      <div class="shop-list flex-grow-1">
                ...
                <div class="slide-split_text position-relative d-flex align-items-center"
                  ...
                  <div class="slideshow-text container p-3 p-xl-5">
                    <h2
                      ...
                      Frauen <br /><strong>ACCESSORIES</strong></h2>
                    <p class="mb-0 animate animate_fade animate_btt animate_delay-5">Accessoires sind die beste Möglichkeit,
                      deinen Look aufzufrischen. Setze ein stylisches Statement mit neuen Farben und Designs – oder entscheide dich für zeitlose Klassiker.</h6>
                  </div>
                </div>
        ...
        <div class="d-flex justify-content-between mb-4 pb-md-2">
          <div class="breadcrumb mb-0 d-none d-md-block flex-grow-1">
            ...
            <a href="#" class="menu-link menu-link_us-s text-uppercase fw-medium">Der Shop</a>
          </div>
...
<form id="frmFilter" method="GET" action="{{ route('shop.index') }}">
  ...
  <select id="sorting" name="sorting" class="...">
    ...
    <option value="date"      {{ $sorting=='date'?'selected':'' }}>Neustes</option>
...
<script>
  $(function () {
      ...
      $("[name='price_range']").on("change", function () {
          ...
          console.log('Slider changed:', values); // ← Testausgabe
          $("#frmfilter").submit();
      });
  });
  </script>
